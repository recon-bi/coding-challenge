...
import CountrySearch from '../CountrySearch'; // Adjust the import path as necessary
...
describe('CountrySearch Component', () => {
  it('renders without crashing', () => {
    ...
    render(<CountrySearch onSelected={onSelectedMock} initialState={mockedOptions} />, container);
  ...
  it('loads the initialState correctly', () => {
    ...
    act(() => {
      ...
      const input: any = screen.getByTestId('countrySearch_Autocomplete');
